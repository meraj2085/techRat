  ...
  return (
    <div className="min-h-screen">
      ...
      <div className="mx-3 md:mx-20 mt-16">
        <hr />
        <article className="rounded-xl w-full md:max-w-md mt-10 shadow-sm border border-gray-200 p-4 my-3">
          <div className="flex items-center gap-4">
            ...
            />
            <div>
              <h3 className="text-md font-medium text-gray-800">Claire Mac</h3>
